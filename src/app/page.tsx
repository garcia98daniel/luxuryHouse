          ...
          <div className="grid gap-8 md:grid-cols-4">
            {t.team.members.map((member, index) => (
              ...
              >
                ...
                {/* Instagram handle - appears on hover on desktop, always visible on mobile */}
                <div className="opacity-100 md:opacity-0 group-hover:opacity-100 transition-opacity duration-300 mt-2">
